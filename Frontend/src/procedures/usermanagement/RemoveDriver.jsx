...
const RemoveDriver = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setPopup({
        visible: true,
        message: "Error removing driver. Please try again.",
        neutral: false,
      });
  ...
  return (
    <div className="flex justify-center items-center h-full min-h-screen pt-[15vh] pb-[5vh] bg-[#F3F1E5]">
      <div className="h-3/3 w-1/3 p-6 rounded-md border border-black bg-white text-black shadow-[4px_4px_0px_0px_rgba(0,0,0)]">
        <h1 className="text-2xl font-bold mb-4">REMOVE_DRIVER_ROLE()</h1>
