...
const AddBusiness = () => {
  ...
  const requirements = [
    ...
    { id: "rating", label: "Business Rating", type: "number", value: "" },
    {
      id: "spent",
      label: "Spent",
      type: "number",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8080/company/addBusiness",
        processedInputs
      );
      ...
      setPopup({
        visible: true,
        message: "Error adding business. Please try again.",
        neutral: false,
      });
  ...
  return (
    <div className={procedurePagesCss}>
      <div className="h-3/3 w-1/3 p-6 rounded-md border border-black bg-white text-black shadow-[4px_4px_0px_0px_rgba(0,0,0)]">
        <h1 className="text-2xl font-bold mb-4">ADD_BUSINESS()</h1>
